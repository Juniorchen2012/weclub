...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.mode == MBProgressHUDModeText && self.yOffset == -155.f) {
        boxRect = CGRectMake(0, roundf((allRect.size.height - size.height) / 2) + self.yOffset, allRect.size.width, size.height);
    }
	float radius = 10.0f;
